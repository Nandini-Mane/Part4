...
describe('most blogs', () => {
  const blogs = [
    { title: "React patterns", author: "Michael Chan", blogs: 1, likes: 7 },
    { title: "Go To Statement Considered Harmful", author: "Edsger W. Dijkstra", blogs: 1, likes: 5 },
    { title: "Canonical string representation of JSON", author: "Edsger W. Dijkstra", blogs: 1, likes: 12 },
    { title: "First class tests", author: "Robert C. Martin", blogs: 1, likes: 10 },
    { title: "TDD harms architecture", author: "Robert C. Martin", blogs: 1, likes: 0 },
    { title: "Type wars", author: "Robert C. Martin", blogs: 1, likes: 2 },
  ]
